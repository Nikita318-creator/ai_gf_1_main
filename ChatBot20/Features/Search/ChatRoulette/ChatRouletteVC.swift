...
class ChatRouletteVC: UIViewController {
    ...
    private func stopSimulationAndProceed() {
        ...
        let selectedAge = ConfigService.shared.isTestB ? ageThemes[selectedAdultIndex] : "Roulette_Age_Option2".localize()
...
extension ChatRouletteVC: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func numberOfSections(in collectionView: UICollectionView) -> Int {
        return ConfigService.shared.isTestB ? 3 : 2
    }
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        case 2: return ConfigService.shared.isTestB ? ageThemes.count : 0
        default: return 0
        }
    }
