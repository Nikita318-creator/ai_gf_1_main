...
//    private let yearlyPlanView = SubscriptionPlanView() // Оставили только годовой план
...
//
//    private var selectedPlanType: PlanType = .yearly // По умолчанию всегда годовой план
//   
//    enum PlanType {
//        case yearly // Оставили только годовой план
//    }
//   
//    enum Constants {
...
//        iconImageView.image = UIImage(named: "5")
...
//       
//        // Title Label - более выразительный, для спецпредложения
//        titleLabel.text = "Subs.Trial.Title".localize() 
...
//        subtitleLabel.text = "Subs.Trial.SubTitle".localize() 
...
//       
//        // Setup Subscription Plan View - теперь только один план
//        setupPlanView(yearlyPlanView, title: "Subs.year".localize(), action: #selector(yearlyButtonTapped))
//        contentView.addSubview(yearlyPlanView)
//       
//        // Best Value Badge - более заметный, всегда видим для годового плана
//        setupBestValueBadge()
...
//        setupBottomButtons()
//       
//        // Устанавливаем годовой план по умолчанию при инициализации
//        yearlyButtonTapped()
//    }
//   
...
//        planView.setTitle(title, isTrial: true)
...
//        }
//       
//        // Yearly Plan View - теперь одна кнопка
//        yearlyPlanView.snp.makeConstraints { make in
...
//            make.top.equalTo(yearlyPlanView.snp.bottom).offset(24)
//            make.leading.equalToSuperview().offset(32)
//            make.trailing.equalToSuperview().offset(-32)
//        }
//       
//        cancelAnyTimeLabel.snp.makeConstraints { make in
//            make.top.equalTo(trialInfoLabel.snp.bottom).offset(24)
//            make.leading.equalToSuperview().offset(32)
//            make.trailing.equalToSuperview().offset(-32)
...
//            make.bottom.equalTo(termsOfUseButton.snp.top).offset(-20)
//            make.leading.equalToSuperview().offset(24)
//            make.trailing.equalToSuperview().offset(-24)
...
//            yearlyPlanView.setTitle("Subs.year".localize(), isTrial: true)
...
//        // Теперь всегда используем идентификатор годового плана
//        let productIdentifier = SubsIDs.yearlyOld
//       
...
//        IAPService.shared.restorePurchases() { [weak self] result in
...
//        yearlyPlanView.setSelected(true)
//       
//        // Простое обновление видимости badge без анимаций
//        bestValueBadge.isHidden = false
//       
//        // Обновляем цвет кнопки в зависимости от выбранного плана
//        let buttonColor = UIColor(hex: "#34C759") // Зеленый цвет для годового плана
...
//
//                    WebHookAnaliticksService.shared.sendErrorReport(messageText: "TRIAL!!! \(productIdentifier) for user: \(WebHookAnaliticksService.shared.randomID) + \(Locale.preferredLanguages.first ?? "en-US")")
//
//                    
//                    self?.onPaywallClosed()
//                }
