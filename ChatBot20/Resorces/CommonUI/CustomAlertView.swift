...
class CustomAlertView: UIView {
    ...
    enum CustomAlertType {
        ...
        case premiumAssistant
        case assistantCountLimitReached
        case giftFromUs
        case roleplay
    ...
    private func setupUI() {
        ...
        switch type {
        case .reviewRequest:
            title = "ReviewRequest.Title".localize()
            message = "ReviewRequest.Message".localize()
            okButtonText = "ReviewRequest.Review".localize()
            later = "ReviewRequest.Later".localize()
        case .shareRequest:
            title = "ShareRequest.Title".localize()
            message = "ShareRequest.Message".localize()
            okButtonText = "ShareRequest.Share".localize()
            later = "ReviewRequest.Later".localize()
        case .dailyLimitReached:
            ...
            later = "OK".localize()
        case .assistantCountLimitReached:
            title = "LimitReached.title".localize()
            message = "LimitReached.message".localize()
            okButtonText = "DailyLimitReached.GoPremium".localize()
            later = "OK".localize()
        case .premiumAssistant:
            title = "PremiumAssistant.title".localize()
            message = "PremiumAssistant.message".localize()
            okButtonText = "DailyLimitReached.GoPremium".localize()
            later = "OK".localize()
        case .giftFromUs:
        ...
        case .roleplay:
            ...
            later = "OK".localize()
        case .onlyPremiumUserCanSentPhotos:
            title = "onlyPremiumUserCanSentPhotos.Title".localize()
            message = "onlyPremiumUserCanSentPhotos.Message".localize()
            okButtonText = "DailyLimitReached.GoPremium".localize()
            later = "OK".localize()
        case .needPremiumForAudio:
