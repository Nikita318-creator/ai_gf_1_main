...
class StoriesView: UIView {
    ...
    func setupMockStories() {
        ...
        stories = [
            StoryModel(id: "1", imageName: "1", detailImageName: MainHelper.shared.picIBlondDs.randomElement() ?? "", title: "Template.Girlfriend1".localize(), description: storiesTexts.randomElement() ?? "", isViewed: seenIDs.contains("1")),
            ...
            StoryModel(id: "mainAvatar1", imageName: "mainAvatar1", detailImageName: MainHelper.shared.picLatinaIDs.randomElement() ?? "", title: "Template.Girlfriend16".localize(), description: storiesTexts.randomElement() ?? "", isViewed: seenIDs.contains("mainAvatar1")),
